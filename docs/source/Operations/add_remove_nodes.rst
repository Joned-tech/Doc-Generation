...
- The new nodes have been provisioned with an operating system via
  `Discover Nodes <../HowTo/Setup/discover_nodes>`_ and `Pxe Boot Nodes <../HowTo/Setup/pxe_boot_nodes>`_.
...
.. note::
   ...
   - `Add Slurm Nodes <../HowTo/Slurm/add_slurm_nodes>`_ -- Detailed how-to for adding Slurm nodes.
   - `Remove Slurm Nodes <../HowTo/Slurm/remove_slurm_nodes>`_ -- Detailed how-to for removing Slurm nodes.
   - `Reprovision Cluster <reprovision_cluster>`_ -- Re-image nodes instead of just adding/removing them.
