...
.. list-table::
   ...
   * - ☐
     ...
     - `Prerequisites Checklist <../GetStarted/prerequisites_checklist>`_
   * - ☐
   ...
   * - ☐
     ...
     - `Security Hardening <security_hardening>`_
...
.. list-table::
   ...
   * - ☐
     ...
     - `Setup Telemetry <../HowTo/Telemetry/setup_telemetry>`_
   * - ☐
     ...
     - `Deploy Powerscale Csi <../HowTo/Kubernetes/deploy_powerscale_csi>`_
   * - ☐
     ...
     - `Configure Nfs <../HowTo/Storage/configure_nfs>`_
...
.. list-table::
   ...
   * - ☐
     ...
     - `General <../Troubleshooting/general>`_
   * - ☐
...
.. note::
   ...
   - `Prerequisites Checklist <../GetStarted/prerequisites_checklist>`_ -- Detailed prerequisites for
     all deployment paths.
   - `Security Hardening <security_hardening>`_ -- Full security hardening procedures.
   - `Log Management <log_management>`_ -- Log monitoring and rotation configuration.
