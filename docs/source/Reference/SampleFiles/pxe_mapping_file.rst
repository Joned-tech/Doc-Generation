...
.. list-table::
   ...
   * - ``HOSTNAME``
     - Yes
     - Hostname to assign to the node. Must comply with hostname rules (see `Hostname Requirements <../Appendices/hostname_requirements>`_).
   * - ``ADMIN_MAC``
     - Yes
...
- For HA, use 3 control plane nodes (see
  `Ha Config <../Configuration/ha_config>`_).
...
.. list-table::
   ...
   * - Hostname format
     - Lowercase, no domain suffix, RFC 952/1123 compliant. See `Hostname Requirements <../Appendices/hostname_requirements>`_.
   * - IP within subnet
...
.. note::
   ...
   - `Provision Config <../Configuration/provision_config>`_ -- Where the mapping
     file path is specified.
   - `Software Config <../Configuration/software_config>`_ -- Software packages
     per functional group.
   - `Hostname Requirements <../Appendices/hostname_requirements>`_ -- Hostname rules.
