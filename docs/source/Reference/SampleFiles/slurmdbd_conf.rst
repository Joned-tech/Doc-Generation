...
.. note::
   ...
   - `Slurm Conf <slurm_conf>`_ -- Companion ``slurm.conf`` configuration.
   - `Omnia Config <../Configuration/omnia_config>`_ -- Omnia-level Slurm
     settings.
   - `Ports <../ClusterRequirements/ports>`_ -- Port 6819 for slurmdbd.
