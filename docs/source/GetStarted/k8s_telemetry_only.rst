...
.. note::
   ...
   Complete the `Prerequisites Checklist <prerequisites_checklist>`_ before proceeding. Pay
...
**Add Slurm later**
   Follow `Full Deployment <full_deployment>`_ (Path B) to add Slurm head, compute,
...
.. note::
   ...
   - `Full Deployment <full_deployment>`_ -- Add Slurm to this K8s deployment
   - `Prerequisites Checklist <prerequisites_checklist>`_ -- Master checklist
   - `Telemetry Architecture <../Overview/telemetry_architecture>`_ -- Deep dive into the telemetry pipeline
