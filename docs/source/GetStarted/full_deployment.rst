...
**Enable BuildStreaM for GitOps**
   See `Buildstream Deployment <buildstream_deployment>`_ (Path D) to layer CI/CD automation
...
.. note::
   ...
   - `Slurm Quickstart <slurm_quickstart>`_ -- Simplified 4-node Slurm deployment
   - `K8S Telemetry Only <k8s_telemetry_only>`_ -- Telemetry without Slurm
