...
- A Kubernetes cluster deployed with 3 control-plane nodes (see
  `Setup Service K8S <setup_service_k8s>`_).
...
- `Deploy Powerscale Csi <deploy_powerscale_csi>`_ -- Deploy enterprise storage integration.
- `Setup Telemetry <../Telemetry/setup_telemetry>`_ -- Deploy telemetry on the HA
  cluster.
