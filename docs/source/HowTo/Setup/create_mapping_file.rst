...
- `Configure Inputs <configure_inputs>`_ -- Configure software and cluster input files.
- `Configure Credentials <configure_credentials>`_ -- Set up encrypted provisioning credentials.
- `Discover Nodes <discover_nodes>`_ -- Run the discovery playbook using this mapping file.
