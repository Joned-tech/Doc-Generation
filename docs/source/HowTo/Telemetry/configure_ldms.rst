...
- The `Setup Telemetry <setup_telemetry>`_ procedure is complete (LDMS is deployed).
...
- `Configure External Kafka <configure_external_kafka>`_ -- Route LDMS data through external Kafka.
